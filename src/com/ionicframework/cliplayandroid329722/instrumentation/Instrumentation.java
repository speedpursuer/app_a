...
package com.ionicframework.cliplayandroid329722.instrumentation;
...
public class Instrumentation {
  ...
  public void init(final String tag, final com.ionicframework.cliplayandroid329722.instrumentation.PerfListener perfListener) {
  ...
  public void onFailure(Throwable throwable) {
    ...
    final long elapsedTime = mFinishTime - mStartTime;
    mPerfListener.reportFailure(elapsedTime);
    FLog.i(TAG, "Image [%s]: failed after %d ms = %s", mTag, elapsedTime, throwable.toString());
  }
